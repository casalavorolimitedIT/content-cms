...
import SmartImage from "../app/custom/smart-images";
      ...
      >
        ...
        {showPreview ? (
          ...
          <div className="relative aspect-video w-full">
            ...
            <div className="absolute inset-0 bg-linear-to-b from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none rounded-xl" />
            ...
            {file && (
              <div className="absolute bottom-0 inset-x-0 bg-linear-to-t from-black/60 to-transparent px-3 py-3">
